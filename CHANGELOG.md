...
## v3.2.0 (2024-09-25)
- TvTestプラグイン周りの安定性を向上 #115
    - [xtne6f](https://github.com/xtne6f) さん提供です、ありがとうございます
- ニコニコにログイン後に終了するとフリーズする問題を修正 #116
...
## v3.3.0 (2025-02-22)
- チャンネル変更時にログ欄にチャンネル名を残すように #121
- マウスを重ねた時に同じユーザーのコメントをハイライトするように #123

## v3.3.1 (2025-05-09)
- ニコニコ実況側のバグでチャンネルリダイレクトがうまくいかない問題に応急対処 #126

## v3.3.2 (2025-05-19)
- コメントの表示/非表示ボタンを追加 #127
